        ...
        <div className="max-w-7xl mx-auto">
          <Card heading="Project Architecture Overview" className="mb-12">
            ...
            <p className="text-muted-foreground text-justify mb-4">
              ...
              distinct Next.js applications: a student-facing application portal
              and an administrative dashboard. This separation ensures high
              availability while allowing different security requirements for
              each audience.
            </p>
      ...
      <section className="py-8 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-justify mb-4">
              Security was paramount given the sensitive student data involved.
              We implemented a multi-layered authentication strategy using Kinde
              as our Authentication-as-a-Service provider, featuring email +
          ...
          <div className="space-y-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-justify">
                ...
                dashboard to trigger content updates. We leverage Next.js's full
                spectrum of rendering strategies for optimal performance.
              </p>
            </div>
